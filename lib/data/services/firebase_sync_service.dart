...
class FirebaseSyncService {
  ...
  Map<String, dynamic> _roomToJson(Room room) {
    return {
      ...
      'moveInDate': room.moveInDate?.toIso8601String(),
  ...
  Room _roomFromJson(Map<String, dynamic> json) {
    return Room(
      ...
      depositIncomeId: json['depositIncomeId'] as String? ?? '',
      depositRefundExpenseId: json['depositRefundExpenseId'] as String? ?? '',
      moveInDate: _readNullableDateTime(json['moveInDate']),
